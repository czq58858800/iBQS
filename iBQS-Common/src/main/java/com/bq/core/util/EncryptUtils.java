...
import static com.bq.core.util.ConvertUtils.bytes2HexString;
import static com.bq.core.util.ConvertUtils.hexString2Bytes;
...
public class EncryptUtils {
    ...
    public static void main(String[] args) {
        System.out.println(encryptMD5ToString("123456"));
        System.out.println(encryptMD5ToString(encryptSHA224ToString("BiaoQing-2016.12.19")));
