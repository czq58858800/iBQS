...
public class EncodeUtils {
    ...
    public static String base64Encode2String(String input) {
        byte[] bytes = base64Encode(input);
        String str = null;
        try {
            str = new String(bytes,"UTF-8");
            return str;
        } catch (UnsupportedEncodingException e) {
            throw new IllegalArgumentException(Resources.getMessage("PARAMENT_FAIL"));
        }
    }
    ...
    public static byte[] base64UrlSafeEncode(String input) {
        return Base64.encodeBase64URLSafeString(input.getBytes()).getBytes();
    }


    public static void main(String[] args) {
        System.out.println(base64Encode2String("{\"account\":\"18950037411\",\"smsCode\":57767}"));
    }
