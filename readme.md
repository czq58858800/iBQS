...
- iBQS是Java语言的分布式系统架构。 使用Spring整合开源框架。
...
## 版权声明
iBQS使用 [Apache License 2.0][] 协议.

## 建议
可以先看一下拆分前的版本，地址：[iBQS-old][].
...
![QQ群](http://git.oschina.net/iBQS/iBQS/raw/master/img/1464169485871.png "QQ群一")
![QQ群](http://git.oschina.net/iBQS/iBQS/raw/master/img/1482378175294.png "QQ群二")

## UI效果图

![登录](http://git.oschina.net/iBQS/iBQS/raw/master/img/login.png "登录")
![主页](http://git.oschina.net/iBQS/iBQS/raw/master/img/index.png "主页")
![接口](http://git.oschina.net/iBQS/iBQS/raw/master/img/swagger.png "接口")

## License
iBQS is released under version 2.0 of the [Apache License][].

![捐赠](http://git.oschina.net/iBQS/iBQS/raw/master/img/contribute.png "捐赠")

[Apache License 2.0]: http://www.apache.org/licenses/LICENSE-2.0
[iBQS-old]: http://git.oschina.net/iBQS/iBQS/tree/NoSplit
